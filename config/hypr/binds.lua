...
hl.bind(mainMod .. " + B", hl.dsp.exec_cmd(Browser .. " -P default-release"))
...
hl.bind(mainMod .. " + PRINT",
        hl.dsp.exec_cmd("hyprshot -m region -o ~/Screenshots")) -- Screenshot region of screen
hl.bind(mainMod .. " + SHIFT + PRINT",
        hl.dsp.exec_cmd("hyprshot -m output -o ~/Screenshots")) -- Screenshot entire screen
hl.bind(mainMod .. " + SHIFT + R",
        hl.dsp.exec_cmd("~/.config/waybar/scripts/killwaybar.sh")) -- Kill waybar
hl.bind(mainMod .. " + R",
        hl.dsp.exec_cmd("~/.config/waybar/scripts/startwaybar.sh")) -- Restart waybar
hl.bind(mainMod .. " + W",
        hl.dsp.exec_cmd("~/.config/wallust/scripts/wallust-sync.sh")) -- Temporary (setup to change whenever wallpaper changes)
...
hl.bind(mainMod .. " + F", hl.dsp.window
            .fullscreen_state({internal = 0, client = 2, action = "toggle"}))
...
hl.bind(mainMod .. " + D",
        hl.dsp.window.set_prop({prop = "opacity", value = "0.6 0.6 0.6"}),
        {repeating = true})
hl.bind(mainMod .. " + D",
        hl.dsp.window.set_prop({prop = "opacity", value = "1"}),
        {release = true})
...
hl.bind(mainMod .. " + up",
        hl.dsp.exec_cmd("ddcutil --bus 3 --sleep-multiplier=0.1 setvcp 10 + 5"))
hl.bind(mainMod .. " + down",
        hl.dsp.exec_cmd("ddcutil --bus 3 --sleep-multiplier=0.1 setvcp 10 - 5"))

-- Laptop volume 
hl.bind("XF86AudioLowerVolume",
        hl.dsp.exec_cmd("pactl -- set-sink-volume 0 -5%"))
...
-- Night mode
hl.bind(mainMod .. " + XF86MonBrightnessDown",
        hl.dsp.exec_cmd("hyprctl hyprsunset temperature -300")) -- Increase temperature
hl.bind(mainMod .. " + XF86MonBrightnessUp",
        hl.dsp.exec_cmd("hyprctl hyprsunset temperature +300")) -- Decrease temperature
hl.bind(mainMod .. " + SHIFT + N",
        hl.dsp.exec_cmd("hyprctl hyprsunset temperature 2500")) -- Turn blue-light filter
